...
- Idade não é um problema. Sério. Não é mesmo. Dá pra começar aos 60.
...
Leia e entenda esse texto, com versões em [inglês](http://www.catb.org/esr/faqs/smart-questions.html) ou [português](http://blogofscience.com/perguntas.html) ele é extenso, mas valiosíssimo. Vai te ajudar a conseguir respostas para suas dúvidas. Leia o que puder, como puder, mas não deixe de ler.
...
Você agora deve decidir entre qual caminho seguir. Farei guias com o que eu souber e conseguir de conteúdo comum e específico. Se você não leu o livro que recomendei, leia. Mas vou deixar aqui as mais comuns áreas de atuação com um super resumo explicativo para que você pesquise em outros lugares para mais informações:
...
- Infraestrutura (DevOps)
  ...
  Trabalha como apoio aos desenvolvedores, configurando o ambiente de desenvolvimento, testes e produção. Também é ligado à infraestrutura de TI.
...
6. Comunidades
7. Livros fundamentais da área (e fora dela também)
8. Pessoas e blogs para seguir
